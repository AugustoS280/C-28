...
function draw() {
  ...
  for (var i = 0; i < playerArrows.length; i++) {
    if (playerArrows[i] !== undefined) {
      ...
      /* tem um bug que ele bate, reflete e não conta ponto
      ele só sobe o score quando ele bate e cai, porque ele aponta para baixo e acaba batendo de novo no board
      só vendo para entender certinho*/
